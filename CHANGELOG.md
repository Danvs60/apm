...
- Dependency aliases now reject `.` and `..` and require destinations strictly inside `apm_modules/` after symlink resolution; [rename rejected aliases and review reinstall artifacts](https://microsoft.github.io/apm/troubleshooting/migration/#rejected-dependency-aliases). - by @Danvs60 (#2901)
